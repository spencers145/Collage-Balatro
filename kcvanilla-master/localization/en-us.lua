        ...
        Joker = {
            j_kcvanilla_5day = {
                ...
                text = {'If played hand contains a {C:attention}Straight{},',
                        'each played {C:attention}6 7 8 9{} or {C:attention}10{}',
                        'gives {C:white,X:mult}X1.3{} Mult'}
            },
            j_kcvanilla_chan = {
                name = "Joker-chan",
            ...
            j_kcvanilla_rakugo = {
                name = "Rakugo",
                text = {'If played hand contains a {C:attention}Straight{},',
                        'each played {C:attention}2 3 4 5 6{} or {C:attention}7{}',
                        'gives it {C:attention}rank{} as {C:mult}Mult{}'}
            },
            j_kcvanilla_rats = {
                name = "Rats!",
                text = {'?'}
