...
function Blind:debuff_hand(cards, hand, handname, check)
    ...
    for i=1, #cards do
		...
		G.GAME.joker_context_calculated = false
		--print("began calculating context...")
        SMODS.calculate_context({modify_scoring_hand = true, other_card =  cards[i], full_hand = cards, scoring_hand = scoring_hand}, effects)
		--if G.GAME.context_count then
		--	print("inner context calculations:")
		--	print(G.GAME.context_count)
		--	G.GAME.context_count = 0
		--end
        --print("context calculation time")
