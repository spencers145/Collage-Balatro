    ...
    descriptions = {
        Other = {
            ...
            bunc_linked_group = {
                ['name'] = 'Linked group',
                ['text'] = {
                    [1] = '{C:linked_group,E:1}Linked{} cards in group',
                    [2] = 'are drawn, selected',
                    [3] = 'and destroyed {C:attention}together'
                }
            },
            bunc_drawn_linked_cards = {['text'] = {[1] = '{C:linked_group,E:1}Linked{} in drawn group'}},
            bunc_light_suits = {
                ['name'] = 'Light suits',
                ['text'] = {
            ...
            bunc_consumable_edition_bunc_fluorescent = {
                name = 'Fluorescent',
                text = {
                    'Cannot be debuffed',
                    '{s:0.2} {}',
                    'Earn {C:money}$2{} when used',
                    'or at end of round',
                }
            },
            bunc_consumable_edition_foil = {
                name = 'Foil',
                text = {
                    'When held, {C:chips}+50{} Chips',
                    '{s:0.2} {}',
                    'When used, create a',
                    '{C:attention}Chips Tag'
                }
            },
            bunc_consumable_edition_holo = {
                name = 'Holographic',
                text = {
                    'When held, {C:mult}+10{} Mult',
                    '{s:0.2} {}',
                    'When used, create a',
            ...
            bunc_consumable_edition_polychrome = {
                name = 'Polychrome',
                text = {
                    'When held, {X:mult,C:white}X1.5{} Mult',
                    '{s:0.2} {}',
                    'When used, create a',
                    '{C:attention}Megamult Tag'
                }
            },
            bunc_consumable_edition_bunc_glitter = {
                name = 'Glitter',
                text = {
                    'When held, {X:chips,C:white}X1.3{} Chips',
                    '{s:0.2} {}',
                    'When used, create an',
                    '{C:attention}Ultrachips Tag'
                }
            },
            bunc_consumable_edition_ortalab_anaglyphic = {
                name = 'Anaglyphic',
                text = {
                    'When held, {X:chips,C:white}X1.25{} Chips',
                    'and {X:mult,C:white}X1.25{} Mult',
                    '{s:0.2} {}',
                    'When used, create',
                    'an {C:attention}Ultrachips Tag',
                    'and a {C:attention}Megamult Tag'
                }
            },
            -- Undiscovered
            ...
            bunc_reactive = {
                ...
                ['text'] = {
                    [1] = 'Debuffs card',
                    [2] = 'Sticker is removed when',
                    [3] = 'any {c:attention}Blind{} is {c:attention}skipped{}'
                }
            },
        ...
        Tarot = {
            ...
            c_bunc_lust = {
                ['name'] = 'Lust',
                ['text'] = {
                    [1] = 'Gives {C:money}$#1#{} for every {C:attention}6{}, {C:attention}9{}, {C:attention}Ace{},',
                    [2] = 'and {C:attention}face card{} in hand',
        ...
        Spectral = {
            ...
            c_bunc_the_8 = {
                ['name'] = 'The 8',
                ['text'] = {
                    [1] = '{C:linked_group,E:1}Link together{} any',
        ...
        Polymino = {
            c_bunc_the_i = {
                ['name'] = 'The I',
                ['text'] = {
                    [1] = '{C:linked_group,E:1}Link together{} 4 selected cards',
        ...
        Joker = {
            ...
            j_bunc_wino = {
                ...
                ['text'] = {
                    [1] = 'Scored cards with',
                    [2] = '{C:hearts}Heart{} suit give {C:mult}+2{} Mult,',
                    [3] = '{C:diamonds}Diamond{} suit give {C:chips}+20{} Chips,',
                    [4] = 'and {C:attention}both at once{} give {C:money}$1{}'
                }
            },
            ...
            j_bunc_glue_gun = {
                ...
                ['text'] = {
                    [1] = 'Sell this card to',
                    [2] = '{C:linked_group,E:1}link together{} up to #1#',
            ...
            j_bunc_taped = {
                ['name'] = 'Taped Jokers',
                ['text'] = {
                    [1] = '{C:linked_group,E:1}Link together{} all',
            ...
            j_bunc_rubber_band_ball = {
                ...
                ['text'] = {
                    [1] = '{X:mult,C:white}X#1#{} Mult per {C:linked_group,E:1}link{}',
                    [2] = 'created this run',
                    [3] = '{C:inactive}(Currently {X:mult,C:white}X#2#{C:inactive} Mult)'
                }
            },
            ...
            j_bunc_games_collector = {
                ...
                ['text'] = {
                    [1] = 'Gains {C:chips}+#1#{} Chips',
                    [2] = 'when a {C:linked_group,E:1}linked group{}',
            ...
            j_bunc_wishalloy = {
                ...
                ['text'] = {
                    [1] = '{C:green}#1# in #2#{} chance for',
                    [2] = 'scored {C:bunc_fleurons}Fleurons{} to',
            ...
            j_bunc_unobtanium = {
                ['name'] = 'Unobtanium',
                ['text'] = {
                    [1] = 'Scored {C:attention}base-suit{} {C:bunc_halberds}Halberds{} ',
                    [2] = 'reduce {C:attention}Blind Requirement{} by',
                    [3] = '{C:white,X:bunc_halberds}#1#%{} for each unique {C:attention}suit{}',
                    [4] = 'in scored hand',
                }
            },
            j_bunc_dynasty = {
        ...
        Edition = {
            ...
            e_bunc_fluorescent = {
                ...
                ['text'] = {
                    ...
                    [3] = 'Earn {C:money}$2{} when scored',
                }
            },
            e_bunc_fluorescent_joker = {
                ['name'] = 'Fluorescent',
                ['text'] = {
                    [1] = 'Cannot be flipped or debuffed',
                    [2] = 'Earn {C:money}$2{} at end of round',
                }
            }
        },
        Voucher = {
            ...
            v_bunc_shell_game = {
                ['name'] = 'Shell Game',
                ['text'] = {
                    [1] = 'Choose {C:attention}+1{} more card',
                    [2] = 'from every Booster Pack'
                },
                ['unlock'] = {
                    [1] = 'Open {E:1,C:attention}#1#',
                    [2] = 'Booster Packs',
            ...
            v_bunc_polybius = {
                ...
                ['text'] = {
                    ...
                    [2] = '{C:linked_group,E:1}link{} {C:attention}one more{} card',
                    [3] = '{s:0.6,C:inactive}Extra card can be of any property'
                },
                ['unlock'] = {
                    [1] = 'Create a total of',
                    [2] = '{E:1,C:attention}#1#{} {C:linked_group,E:1}linked groups',
                    [3] = '{C:inactive}(#2#)'
                }
            }
        },
        Enhanced = {
            m_bunc_copper = {
                ['name'] = 'Copper Card',
                ['text'] = {
                    [1] = 'Rescores completely if',
                    [2] = 'played {C:attention}adjacent{} to a',
            ...
            m_bunc_cracker = {
                ...
                ['text'] = {
                    [1] = 'Played and scored',
                    [2] = 'on {C:attention}discard{}, then',
                    [3] = '{C:green}#1#{} in {C:green}#2#{} chance',
                    [4] = 'to be destroyed',
                },
            },
        },
        Stake = {
            ...
            stake_bunc_magenta = {
                ...
                ['text'] = {
                    ...
                    [2] = '{C:inactive,s:0.8}(Card is debuffed until a Blind is skipped)',
                    [3] = '{s:0.8}Applies all previous Stakes'
                }
            }
        }
