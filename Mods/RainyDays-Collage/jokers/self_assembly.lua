SMODS.Joker {
  ...
  calculate = function(self, card, context)
    ...
    if not G.bunc_selecting_linked_card and context.setting_ability and context.other_card.config.center.set ~= 'Voucher' and not context.blueprint and context.old ~= context.new and context.new ~= 'c_base' then
