		...
		["Joker"] = {
			...
			j_ortalab_biker = {
				...
				text = {
					...
					'permanently gains',
					'{C:white,X:mult}X0.01{} Mult when scored'
				}
			},
			['j_ortalab_blacklist'] = {
				["name"] = "Blacklist",
			...
			j_ortalab_dropout = {
				["name"] = "Graduate",
				["text"] = {
					{'Scoring {C:attention}#1#s{} have a',
			...
			['j_ortalab_joker_miles'] = {
				...
				["text"] = {
					"For every {C:money}$#1#{} spent on",
					"cards, vouchers or boosters,",
					"create a random {C:attention}Travel Card",
					"{C:inactive}({C:money}$#2#{}{C:inactive} left)"
				}
			},
			j_ortalab_klutz = {
				name = 'Klutz',
			...
			['j_ortalab_miracle_cure'] = {
				["name"] = "Miracle Cure",
				["text"] = {
					"{C:attention}Debuffed{} and {C:attention}flipped{} cards",
					"are instead {C:attention}retriggered{}",
			...
			['j_ortalab_watching_eye'] = {
				["name"] = "Watching Eye",
				["text"] = {
					"Gives {C:red}#1#{} Mult minus {C:attention}#2#X{} the", 
					"rank of the {C:attention}highest{} ranked card",
			...
			j_ortalab_purple = {
				name = 'Purple Joker',
				text = {
					{'{C:chips}#3#{} Chips, {C:red}#4#{} Mult'},
					{'{C:chips}-#1#{} Chips, {C:red}+#2#{} Mult','after hand played'},
					{'{C:chips}+#1#{} Chips, {C:red}-#2#{} Mult','after discard'},
				}
			},
			j_ortalab_rea = {
				name = 'Rea',
				text = {
					...
					'and {C:attention}seal{} in scoring hand'
				}
			},
			['j_ortalab_red_fred'] = {
				["name"] = "Red Fred",
			...
			['j_ortalab_scantron'] = {
				...
				["text"] = {
					...
					"instead {C:attention}not{} retrigger",}
				}
			},
			...
			j_ortalab_woo_all_1 = {
				["name"] = "Woo! All 1s",
				["text"] = {
					"{X:green,C:white}X0.5{} to all {C:attention}listed{}",
		...
		["Back"] = {
			['b_ortalab_orange'] = {
				...
				["text"] = {
					...
					"{s:0.2} {}",
					"Start with the",
					"{C:attention,T:v_ortalab_recyclo_inv}Leafblower{} Voucher"
				},
				["unlock"] = {
					"Redeem the",
					"{C:attention}Leafblower{} Voucher",
				}
			},
			['b_ortalab_cyan'] = {
				["name"] = "Cyan Deck",
				...
				["unlock"] = {
					"Redeem the",
					"{C:attention}Another's Treasure",
					"Voucher"
				}
			},
			['b_ortalab_shady'] = {
				...
				["text"] = {
					...
					"{C:dark_edition,T:e_ortalab_greyscale}Greyscale {C:attention,T:j_ortalab_black_friday}#1#{} Joker",
					--"and a {C:attention,T:c_vis_coupon}Coupon{} consumable"
				},
				["unlock"] = {
					"Win {C:attention}5{} runs with",
					"{C:attention,E:1}Collage{} installed"
				}
			},
			['b_ortalab_neon'] = {
				["name"] = "Neon Deck",
				["text"] = {
					'Start with {C:attention,T:v_hone}#1#,',
					'{C:attention,T:v_glow_up}#2#{}, and a',
					'copy of {C:attention,T:c_bunc_cleanse}Cleanse',
					'{s:0.2} {}',
					'Lose {C:money}$4{} of starting money'
				},
				["unlock"] = {
					"Win {C:attention}4{} runs with",
					"{C:attention,E:1}Collage{} installed"
				}
				--[[["unlock"] = {
					'Use the {C:attention}Cleanse',
			...
			['b_ortalab_experimental'] = {
				...
				["text"] = {
					"Start with the",
					"{C:attention,T:v_bunc_lamination}#2#{} Voucher",
					"and a copy of",
					"{C:attention,T:c_vis_crystal_ball}Crystal Ball"
				},
				["unlock"] = {
					"Redeem the",
					"{C:attention}Lamination{} Voucher"
				}
			},
			...
			['b_ortalab_royal'] = {
				...
				["text"] = {
					...
					'{s:0.2} ',
					"At end of round,",
					"add 2 {C:attention}random",
					"{C:red}Non-Face Cards",
					"to your deck"
				},
				["unlock"] = {
					"Destroy a",
					"{C:money,E:1}Royal {C:attention}Porcelain Card{}"
				}
			},
			['b_ortalab_prismatic'] = {
				["name"] = "Prismatic Deck",
			...
			['b_ortalab_membership'] = {
				...
				["unlock"] = {
					"Redeem the",
					"{C:attention}Ad Campaign{} Voucher"
				}
			},
			['b_ortalab_sketched'] = {
				["name"] = "Sketched Deck",
				["text"] = { 
					...
					"{s:0.2} {}",
					"Start with {C:attention,T:v_artb_pen_holder}Pen Holder",
				},
				["unlock"] = {
			...
			['b_ortalab_hoarder'] = {
				...
				["unlock"] = {
					"Use {C:attention}Chaos Tags",
					"and get {C:green,E:1}lucky"
				}
			},
			['b_ortalab_frozen'] = {
				["name"] = "Frozen Deck",
		...
		['Voucher'] = {
			...
			v_ortalab_one_mans_trash = {
				...
				text = {
					...
					'and {C:red}#2#{} discards per round'
				}
			},
